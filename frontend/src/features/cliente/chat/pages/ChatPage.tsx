...
import { useChatPage } from '@/features/cliente/chat/hooks/useChatPage'
          ...
          <div className="flex-1 overflow-y-auto py-2">
            {loadingConversas ? (
              ...
              <div className="flex flex-col items-center gap-2 py-16 text-zinc-600">
                ...
                <p className="text-xs">Prontos para uma nova experiência?</p>
              </div>
            ) : (
        ...
        >
          {id ? (
            ...
            <div className="flex flex-1 flex-col items-center justify-center gap-3 text-zinc-600">
              ...
              <p className="text-sm">{conversas?.length === 0 ? 'Prontos para uma nova experiência?' : 'Selecione uma conversa'}</p>
            </div>
          )}
        </div>
