      ...
      <div className="relative z-10 w-full max-w-sm rounded-t-2xl border border-zinc-700 bg-zinc-900 p-6 sm:rounded-2xl">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            >
              <span
                className={`absolute left-0.5 top-0.5 size-5 rounded-full bg-white shadow transition-transform ${local.marketing ? 'translate-x-5' : 'translate-x-0'}`}
              />
            </button>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            >
              <span
                className={`absolute left-0.5 top-0.5 size-5 rounded-full bg-white shadow transition-transform ${local.sistema ? 'translate-x-5' : 'translate-x-0'}`}
              />
            </button>
          </div>
        </div>
