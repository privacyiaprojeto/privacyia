  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-zinc-900 p-6">
      <div className="rounded-2xl border border-zinc-700 bg-zinc-800 p-10 text-center">
        <span className="inline-block rounded-full bg-amber-500/20 px-4 py-1 text-sm font-medium text-amber-400">
          adm
        </span>
        <h1 className="mt-4 text-2xl font-bold text-zinc-100">Painel do Administrador</h1>
